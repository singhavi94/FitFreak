...
if(isset($_SESSION['uname'])){
  ...
  include_once 'careers_report.php';
...
<!DOCTYPE html>
<html>
<title>Fit Freak - Carrer Report</title>
<head>
...
<div style="display:none;" id="myDiv" class="animate-bottom"> 
 ...
 <style>
   #section1_fas{height:100%;padding-top: 130px;padding-bottom: 30px;background-image: url(image/36.jpg);background-repeat: no-repeat;
                  ...
                  <div class="col-lg-12">
                    <!--<h5 style="color:#1c2833;text-align: center;font-size: 26px;"><i class="fa fa-list-alt" style="color: #1c2833;"></i>Canditate </h5>-->
                      <div class="row">
                        ...
                        <div class="col-lg-4">
                          <h4>Applying Designation</h4>
                          <h4>Name</h4>
                          <h4>Email</h4>
                          <h4>Phone Number</h4>
                          <h4>Certificater & Awards</h4>
                        ...
                        <div class="col-lg-5">
                                <h4><?php echo $row["careerdesi"]; ?></h4>
                                <h4><?php echo $row["careername"]; ?></h4>
                                <h4><?php echo $row["careeremail"]; ?></h4>
                                <h4><?php echo $row["careerphone"]; ?></h4>
                                <h4><?php echo $row["careercerti"]; ?></h4>
                                <h4><?php echo $row["careerterms"]; ?></h4>
                        </div>
                        <div class="col-lg-1"></div>
                      </div>        
                  </div>  
