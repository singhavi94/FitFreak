...
<!DOCTYPE html>
<html>
<title>Fit Freak - Contact Us Report</title>
<head>
...
<div style="display:none;" id="myDiv" class="animate-bottom">
 ...
 <style>
   #section1_fas{height:100%;padding-top: 130px;padding-bottom: 30px;background-image: url(image/70.jpg);background-repeat: no-repeat;
        ...
        <div class="col-lg-12" style="background-color:;">
           <div class="admin_dash">
            <h2>CONTACT US REPORT</h2>
             <h3>Contact Us Enquiry User Details</h3>
                  ...
                  <div class="col-lg-12">
                    <!--<h5 style="color:#1c2833;text-align: center;font-size: 26px;"><i class="fa fa-list-alt" style="color: #1c2833;"></i>Canditate </h5>-->
                      <div class="row">
                        ...
                        <div class="col-lg-5">
                                <h4><?php echo $row["concity"]; ?></h4>
                                <h4><?php echo $row["conname"]; ?></h4>
                                <h4><?php echo $row["conemail"]; ?></h4>
                                <h4><?php echo $row["conphone"]; ?></h4>
                                <h4><?php echo $row["conterms"]; ?></h4>
                        </div>
                        <div class="col-lg-1"></div>
                      </div>        
                  </div>  
