...
<div style="display:none;" id="myDiv" class="animate-bottom">
 ...
 <style>
   #section1_fas{height:100%;padding-top: 130px;padding-bottom: 30px;background-image: url(image/109.jpg);background-repeat: no-repeat;
      ...
      <div class="row">
        <div class="col-lg-12" style="background-color:;">
           <div class="admin_dash">
            <h2>CORPORATE MEMBERSHIP REPORT</h2>
