...
<!DOCTYPE html>
<html>
<title>Fit Freak - Feedback Report</title>
<head>
...
<div style="display:none;" id="myDiv" class="animate-bottom"> 
 ...
 <style>
   #section1_fas{height:100%;padding-top: 130px;padding-bottom: 30px;background-image: url(image/39.jpg);background-repeat: no-repeat;
        ...
        <div class="col-lg-12" style="background-color:;">
           <div class="admin_dash">
            <h2>FEEDBACK REPORT</h2>
             <h3>Feedback From Users Details</h3>
                    ...
                    <!--<h5 style="color:#1c2833;text-align: center;font-size: 26px;"><i class="fa fa-list-alt" style="color: #1c2833;"></i>Canditate </h5>-->
                      <div class="row">
                        ...
                        <div class="col-lg-5">
                                ...
                                <h4><?php echo $row["feedbackname"]; ?></h4>
                                <h4><?php echo $row["feedbackphone"]; ?></h4>
                                <h4><?php echo $row["feedbackemail"]; ?></h4>
                                <h4><?php echo $row["feedbackcity"]; ?></h4>
                                <h4><?php echo $row["feedbackstate"]; ?></h4>
                                 <h4><?php echo $row["feedbackdate"]; ?></h4>
                                 <h4><?php echo $row["feedbackcoment"]; ?></h4>
                        </div>
                        <div class="col-lg-1"></div>
                      </div>        
                  </div>  
